...
public class ResourceServiceTest {
    ...
    public void testExecute() throws DataAccessException {
        ...
        // ユーザー情報の権限がリソース管理者(2)のとき、フィールドにリソース情報が正しくセットされる
        // 事前条件：insert1.sqlのデータがcategoriesテーブル、officesテーブル、propertiesテーブル、resourcesテーブルに挿入されている
        // 期待結果：getterの結果、長さ2のList<Resource>が返却される
        // 期待結果：getterの結果、List<Resource>にresourceId=1/deleted=0,resourceId=2/deleted=1のデータが格納されている
    ...
    public void testExecuteNotAdmin() throws DataAccessException {
        ...
        // ユーザー情報の権限が利用者(1)のとき、フィールドにリソース情報が正しくセットされる
        // 事前条件：insert1.sqlのデータがcategoriesテーブル、officesテーブル、propertiesテーブル、resourcesテーブルに挿入されている
        // 期待結果：長さ1のList<Resource>が返却される
        // 期待結果：getterの結果、長さ1のList<Resource>が返却される
        // 期待結果：getterの結果、List<Resource>にresourceId=1/deleted=0のデータが格納されている
