...
import rrs.model.ReservationDetailService;

public class ReservationDetailHandler implements Handler {
    ...
    public String handleService(HttpServletRequest request) {
        ...
        // Modelの生成
        ReservationDetailService service = new ReservationDetailService(reservationId);
