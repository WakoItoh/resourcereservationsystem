...
import rrs.dto.User;
import rrs.model.ReservationCancelConfirmService;

public class ReservationCancelConfirmHandler implements Handler {
    ...
    public String handleService(HttpServletRequest request) {
        ...
        // Modelの生成
        ReservationCancelConfirmService service = new ReservationCancelConfirmService(loginUser, reservationId);
